...
const recommendedPackageByService = [3, 1, 3, 4, 5];
    ...
    <main>
        ...
        <div className={`service-track ${priceOpen ? "show-price" : ""}`}>
          ...
          <div className="price-page section-shell" aria-hidden={!priceOpen}>
            ...
            <div className="price-heading">
              ...
              <p>선택한 서비스에 적합한 패키지를 먼저 추천합니다<br />다른 단계를 눌러 구성과 시작가를 비교할 수 있습니다</p>
            </div>
      ...
      <section className="about section-shell" id="about">
        <div className="about-visual">
          <div className="trust-bars" aria-hidden="true"><span /><span /><span /></div>
          <img className="about-mark" src="/media/fiducia-mark-white.png" alt="" aria-hidden="true" />
          <span className="about-caption">DIFFERENT SHAPES / ONE TRUST</span>
        </div>
